...
public class id_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("string.id");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("Begin", "string.id");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("End", "string.id");
  ...
  public String getSentence(int addr) {
      ...
      jcas.throwFeatMissing("Sentence", "string.id");
